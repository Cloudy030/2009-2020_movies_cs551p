...
@given(u'I navigate to rating movie page')
def nav(context):
    """ 
    Navigate to the rating movie page
    """
    context.browser.get('https://sierraviolin-learncombine-5000.codio-box.uk/rating_movie/PG')

@when(u'I click on the movie name in rating list')
def click(context):
    """ 
